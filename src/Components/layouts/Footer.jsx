...
export default function Footer() {
  ...
  const socialLinks = [
    { icon: FiLinkedin, href: 'https://www.linkedin.com/in/sushant-khatiwada/', label: 'LinkedIn' },
    { icon: FiMail, href: 'mailto:khatiwadavyasa@gmail.com', label: 'Email' },
  ];

  const quickLinks = [
    { name: 'Home', href: '#home' },
    { name: 'Entrepreneurial Ventures', href: '#entrepreneurship' },
    ...
    <footer className="bg-stone-950 text-stone-400 py-16 md:py-20 relative overflow-hidden border-t border-stone-900">
      ...
      <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="md:col-span-5 space-y-6">
            ...
            >
              <h3 className="text-2xl font-bold text-stone-100 mb-2 tracking-tight">
                Sushant<span className="text-emerald-500">.</span>
              </h3>
              <p className="text-stone-500 leading-relaxed max-w-sm">
               Founder and Product Manager focused on developing high-impact startups and professional consulting services with a global business mindset.
              </p>
            </motion.div>
          ...
          <div className="md:col-span-4">
             ...
             <div className="p-4 rounded-xl bg-stone-900 border border-stone-800">
                <div className="flex items-center gap-3 mb-2 text-stone-200 font-mono text-sm">
                   ...
                   <span>Discuss a Venture or Consulting?</span>
                </div>
                <p className="text-xs text-stone-500 mb-3">
                   Let's discuss how we can help your business grow.
                </p>
                <a 
                  href="mailto:khatiwadavyasa@gmail.com" 
        ...
        <div className="border-t border-stone-900 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs font-mono text-stone-600">
           ...
           <p>
              // Designed & Built by <span className="text-stone-400">Sushant Khatiwada</span>
           </p>
        </div>
      </div>
