...
import profileImg from '../../assets/images/Sushant.jpeg';
      ...
      >
        <div className="relative w-full h-full transform-style-3d bg-stone-900">
          ...
          <motion.img
            ...
            width="384"
            height="480"
            alt="Sushant Khatiwada - Founder and Product Manager"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7">
            ...
            >
              ...
              >
                Sushant Khatiwada | Founder & Product Strategist
              </h1>
              ...
              <h2 className="text-5xl md:text-7xl lg:text-8xl font-bold text-stone-900 tracking-tight leading-[1.1] mb-8">
                <AnimatedText text="Building" delay={0.1} />
                <AnimatedText text="Startups &" delay={0.3} />
              ...
              >I'm Sushant Khatiwada, a Founder and Product Manager passionate about building 0→1 startups and high-impact digital ecosystems. I combine professional expertise in immigration law and business development with a product-first mindset to solve real-world industry gaps.
              </motion.p>
              ...
              >
                ...
                <a
                  href="https://drive.google.com/file/d/1k6Fw3TsRKWOPaO_qFFJDRQlmy7swcmlT/view?usp=sharing"
                  target="_blank"
