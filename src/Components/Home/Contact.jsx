...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch("https://formsubmit.co/ajax/khatiwadavyasa@gmail.com", {
        method: "POST",
        headers: { 
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="text-lg text-stone-600 leading-relaxed max-w-2xl mx-auto">
            Interested in working together? I'm always open to discussing new ventures, consulting opportunities, or startup collaborations.
          </p>
        </motion.div>
          ...
          >
             <div className="bg-white p-8 rounded-3xl shadow-sm border border-stone-100 relative overflow-hidden group neon-border-card">
                ...
                <div className="space-y-6 relative z-10">
                   <a href="mailto:khatiwadavyasa@gmail.com" className="flex items-start gap-4 group/item">
                      ...
                      <div>
                        ...
                        <span className="text-lg font-medium text-stone-900 group-hover/item:text-emerald-600 transition-colors">khatiwadavyasa@gmail.com</span>
                      </div>
                   </a>
