...
const experiences = [
  {
    id: 1,
    title: "Global Gateway Migration Services",
    subtitle: "Consultancy Services",
    role: "Consultant",
    period: "Feb 2023 - July 2023",
    type: "Corporate",
    icon: FaBuilding,
    description: "As a Consultant, I managed end-to-end client interactions and provided strategic guidance on international migration pathways, improving operational workflows and case handling through data-driven processes.",
    achievements: [
      "Managed 30+ client cases monthly, mapping individual profiles to suitable immigration pathways",
      "Identified onboarding inefficiencies and improved internal workflows for better process efficiency",
      "Maintained end-to-end lifecycle tracking of client applications using CRM systems",
      "Transformed operational data into structured reports to support decision-making",
      "Expertise in Interpersonal Skills and Document Management"
    ],
    tech: ["CRM", "Document Management", "Client Relations", "Workflow Optimization"]
  },
  {
    id: 2,
    title: "Tribhuvan University",
    subtitle: "Financial Planning and Services",
    role: "Bachelor of Business Studies",
    period: "Oct 2019 – Oct 2024",
    type: "Education",
    icon: FaGraduationCap,
    description: "Specialized in Financial Planning and Services, building a strong foundation in business administration and market dynamics.",
    achievements: [
      "Extensive study of financial systems and business strategy",
      "Participated in various leadership and management workshops",
      "Collaborated on student-led initiatives within the business department"
    ],
    tech: ["Finance", "Business Studies", "Planning", "Market Research"]
  },
  {
    id: 3,
    ...
    type: "Education",
    icon: FaGraduationCap,
    description: "Focused on Law and Social Sciences, gaining insights into legal frameworks and societal structures.",
    achievements: [
      "Developed strong analytical and critical thinking skills",
      "Active participant in legal debate and societal research projects",
      "High academic performance in specialized law subjects"
    ],
    tech: ["Law", "Social Sciences", "Ethics", "Legal Theory"]
  },
  ...
  return (
    <section id="experience" ref={containerRef} className="py-24 bg-stone-50/50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
            <a href="https://drive.google.com/file/d/1k6Fw3TsRKWOPaO_qFFJDRQlmy7swcmlT/view?usp=sharing" target="_blank" className="inline-flex items-center gap-2 group px-6 py-3 bg-stone-900 text-white rounded-lg font-bold hover:bg-stone-800 transition-all shadow-lg hover:shadow-emerald-500/20 neon-border-card">
                <span>Resume / CV</span>
