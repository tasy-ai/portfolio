...
const ventures = [
  {
    ...
    type: "Start-up · Full-time",
    icon: FaRocket,
    link: "https://tasyai.vercel.app/",
    description: "Building a 0→1 platform focused on solving the “idea-to-cofounder gap” by enabling structured, intent-driven matching between aspiring founders. Leading product direction, user research, and go-to-market strategy.",
    achievements: [
      "Conducted 40+ user interviews to uncover key pain points like lack of trust signals and fragmented idea discovery",
      "Translated insights into core features including intent-based profiles and intelligent collaborator matching",
      "Reduced feature scope by 35% using impact vs effort prioritization to accelerate MVP launch",
      "Designed end-to-end user journeys, wireframes, and PRDs to enable faster product iterations",
      "Built a validation funnel and waitlist, using conversion data to refine product positioning",
      "Leading a community-driven GTM strategy to drive early traction and network effects"
    ],
    tech: ["Product Management", "Business Development", "User Research", "GTM Strategy", "Interpersonal Skills"]
  },
  {
    id: 2,
    title: "Unisire",
    subtitle: "EdTech & Career Guidance",
    role: "Co-Founder & CEO",
    period: "Jan 2025 - Dec 2025",
    type: "EdTech · Full-time",
    icon: FaLightbulb,
    link: "https://www.unisire.com/",
    description: "Led the vision, strategy, and execution of an EdTech platform aimed at solving decision paralysis in tech learning. Drove product development from ideation to launch, ensuring a user-centric and scalable approach.",
    achievements: [
      "Defined product vision, strategy, and execution roadmap from 0 to 1",
      "Designed and delivered core features including structured roadmaps and an ATS-friendly resume builder",
      "Led product scoping, sprint prioritization, and cross-functional execution",
      "Analyzed user behavior and engagement data to identify retention gaps and drop-offs",
      "Evaluated product-market fit through feedback and data insights, leading to a strategic sunset decision",
      "Applied key learnings to improve activation, retention, and product validation strategies"
    ],
    tech: ["Recruiting", "Strategy", "Product Execution", "Data Analysis", "Leadership"]
  }
];
