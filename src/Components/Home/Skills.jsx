...
import { 
  FaGlobe, FaPassport, FaGavel, FaUserCheck, FaUserPlus, FaUserGraduate, 
  FaUserTie, FaHandshake, FaChartLine, FaBriefcase, FaFileSignature,
  FaFileAlt, FaHeadset, FaLightbulb, FaBrain, FaUsers, FaTasks,
  FaBullhorn, FaCode, FaChevronDown
} from 'react-icons/fa';
...
const skillIconMap = {
  // Immigration & Law
  'Immigration Law': FaGavel,
  'Canadian Immigration Law': FaPassport,
  'UK Immigration': FaGlobe,
  'Global Immigration': FaGlobe,
  'Employment-based Immigration': FaBriefcase,
  'Immigration': FaPassport,
  'Immigration Issues': FaGavel,

  // Recruitment & Counseling
  'Recruiting': FaUserPlus,
  'Higher Education Recruitment': FaUserGraduate,
  'Student Counseling': FaUserCheck,
  'Career Counseling': FaUserCheck,
  ...
  'Customer Relationship Management (CRM)': FaUsers,

  // Management & Leadership
  'Leadership': FaTasks,
  'Management': FaUserTie,
  'Problem Solving': FaLightbulb,
  'Analytical Skills': FaBrain,

  // Operations & Core
  'Document Management': FaFileAlt,
  'Document Preparation': FaFileSignature,
  'Customer Service': FaHeadset,
  'Interpersonal Skills': FaUsers,
  'Persuasion': FaBullhorn
};
    ...
    <section id="skills" className="py-24 bg-stone-50/50 relative">
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
           ...
           >
             Professional <span className="text-emerald-600">Expertise</span>
           </motion.h2>
           <motion.p 
            initial={{ opacity: 0 }}
           ...
           >
            A comprehensive overview of my professional skills, specialized in global immigration, 
             recruitment strategies, and business development.
           </motion.p>
        </div>
